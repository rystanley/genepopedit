...
#### genepop_toploci.R
Calculate the fst for unlinked loci and order by fst. This function will order loci by fst and will maximize the sum of FSTs for unlinked loci. Note this function requires both PGDspider and plink.
