...
Once you select a method to sub-sample each population, you can use the function \subset_genepop_indiv to create the sampled genepop file.

For example if you wanted to create a training dataset in genepop format using the SubSamp wh
