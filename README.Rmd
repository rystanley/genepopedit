...
*genepopedit* was written in collaboration:
  ...
  * Dr. Ryan Stanley^1^ <https://github.com/rystanley>
...
#rename populations
  subset_genepop_rename(GenePop=GenePopData,path=paste0(output_dir,"Genepop_renamed_renumbered.txt"),nameframe=PopRename_group)
```
...
#convert Genepop format to genotype *note this returns the genotype object to the workspace.
  GenotypeData <- genepop_genotype(GenePop="Genepop_IDsubset.txt")
```
