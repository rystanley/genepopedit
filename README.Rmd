...
**Note that warning messages & daignostics will be returned to the console by PGDspider & PLINK. These warnings are expected.** 
...
#We will provide the function with access to 2 GB of ram (default: 1) to speed up this conversion.
