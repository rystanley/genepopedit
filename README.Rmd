...
![workflow-structure](vignette/vignette.png)  
__Fig 1.__ *Workflow genepopedit including data preparation, diagnostics, manipulation and transformation. Files, functions, and function operations are denoted by black, grey and blue text, respectively. Function inputs and outputs are denoted by dashed and solid lines, respectively.*
