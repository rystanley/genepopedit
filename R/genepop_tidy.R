...
#' \href{http://genepop.curtin.edu.au/help_input.html}{genepop} file into
#' a wide or long/tidy data frame
#' @description Used internally in
#' \href{https://github.com/ryanstanley/genepopedit}{genepopedit}
#' might be of interest for users.
#' The function \code{genepop_tidy} reads a file in the
#' \href{http://genepop.curtin.edu.au/help_input.html}{genepop format}
#' (see details and note for convention) and output a data frame in wide or
#' long/tidy format.
...
#' @importFrom stringi stri_split_fixed stri_replace_all_fixed stri_join
...
#' Ryan Stanley \email{ryan.stanley@@dfo-mpo.gc.ca}


genepop_tidy <- function(data, strata = NULL, tidy = TRUE, filename = NULL) {
