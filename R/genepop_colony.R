...
genepop_colony <- function(GenePop, where.PLINK, where.PGDspider, denote.missing = "000", allocate.PGD.RAM = 1){
  ...
  GenePop <- "/Users/brendanwringe/Desktop/DFO Aquaculture Interaction/Salmon SNP Data Feb 16 2016 - WIld Captures/Wild Capture Analysis March 17 2016/test/NLRecapturedSalmon_NoMHC.txt"
